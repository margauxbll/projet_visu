...
df_nb_conso_annee.columns = ["Opérateur", "Année","Nb"] #Renommage des colonnes
df_nb_conso_annee = df_nb_conso_annee[(df_nb_conso_annee['Opérateur'] == 'Enedis') | (df_nb_conso_annee['Opérateur'] == 'GRDF') ]
print(df_nb_conso_annee)
df_nb_conso_annee['Année'] = df_nb_conso_annee["Année"].astype(str)
# donnees_nb_conso_annee = ColumnDataSource(df_nb_conso_annee)
# -- Ajouter les barres
# p5 = figure(x_range = df_nb_conso['Opérateur'].unique(), title="Nombre d'opérateurs")
# p5.vbar(x='Opérateur', top='Nb', width=0.9, source=donnees_nb_conso)
# source = ColumnDataSource(data=donnees_nb_conso_annee)

from bokeh.models import ColumnDataSource, FactorRange
from bokeh.plotting import figure, show

# this creates [ ("Apples", "2015"), ("Apples", "2016"), ("Apples", "2017"), ("Pears", "2015), ... ]
x = [ (annee, op) for op in df_nb_conso_annee['Opérateur'].unique() for annee in df_nb_conso_annee['Année'].unique() ]
print(x)
